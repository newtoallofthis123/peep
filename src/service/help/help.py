...
class Help:
    ...
    def help_content(self):
        ...
        console.print(figlet.renderText("PEEP"), style="green")
        console.print(Panel.fit("NoobScience's PEEP: Personalized Environment and Execution Prompt", title="Help", border_style="green"), justify="center")
